...
inline HRESULT iconv_posix(const char *code1, const char *code2,
...
inline HRESULT utf16le_2_mbcs_posix(const void *src, size_t src_size, void *dst, size_t *dst_size)
{
    return iconv_posix(ICONV_CODE_UTF16LE, ICONV_CODE_MBCS, src, src_size, dst, dst_size);
}

inline HRESULT mbcs_2_utf16le_posix(const void *src, size_t src_size, void *dst, size_t *dst_size)
{
    return iconv_posix(ICONV_CODE_MBCS, ICONV_CODE_UTF16LE, src, src_size, dst, dst_size);
}

inline HRESULT utf8_2_utf16le_posix(const void *src, size_t src_size, void *dst, size_t *dst_size)
{
    return iconv_posix(ICONV_CODE_UTF8, ICONV_CODE_UTF16LE, src, src_size, dst, dst_size);
}

inline HRESULT utf16le_2_utf8_posix(const void *src, size_t src_size, void *dst, size_t *dst_size)
{
    return iconv_posix(ICONV_CODE_UTF16LE, ICONV_CODE_UTF8, src, src_size, dst, dst_size);
}

inline HRESULT mbcs_2_utf32le_posix(const void *src, size_t src_size, void *dst, size_t *dst_size)
{
    return iconv_posix(ICONV_CODE_MBCS, ICONV_CODE_UTF32LE, src, src_size, dst, dst_size);
}

inline HRESULT utf32le_2_mbcs_posix(const void *src, size_t src_size, void *dst, size_t *dst_size)
{
    return iconv_posix(ICONV_CODE_UTF32LE, ICONV_CODE_MBCS, src, src_size, dst, dst_size);
}

inline HRESULT utf32le_2_utf8_posix(const void *src, size_t src_size, void *dst, size_t *dst_size)
{
    return iconv_posix(ICONV_CODE_UTF32LE, ICONV_CODE_UTF8, src, src_size, dst, dst_size);
}

inline HRESULT utf8_2_utf32le_posix(const void *src, size_t src_size, void *dst, size_t *dst_size)
{
    return iconv_posix(ICONV_CODE_UTF8, ICONV_CODE_UTF32LE, src, src_size, dst, dst_size);
}

inline HRESULT utf32le_2_utf16le_posix(const void *src, size_t src_size, void *dst, size_t *dst_size)
{
    return iconv_posix(ICONV_CODE_UTF32LE, ICONV_CODE_UTF16LE, src, src_size, dst, dst_size);
}

inline HRESULT utf16le_2_utf32le_posix(const void *src, size_t src_size, void *dst, size_t *dst_size)
{
    return iconv_posix(ICONV_CODE_UTF16LE, ICONV_CODE_UTF32LE, src, src_size, dst, dst_size);
}

inline HRESULT mbcs_2_utf8_posix(const void *src, size_t src_size, void *dst, size_t *dst_size)
{
    return iconv_posix(ICONV_CODE_MBCS, ICONV_CODE_UTF8, src, src_size, dst, dst_size);
}

inline HRESULT utf8_2_mbcs_posix(const void *src, size_t src_size, void *dst, size_t *dst_size)
{
