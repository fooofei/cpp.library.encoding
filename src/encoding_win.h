...
inline
HRESULT utf16le_2_mbcs_windows(const wchar_t * src, size_t src_size, char * dst, size_t * dst_size)
{
...
inline
HRESULT mbcs_2_utf16le_windows(const char * src, size_t src_size, wchar_t * dst, size_t * dst_size)
{
