...
HRESULT
encoding::mbcs_2_utf16le(const void *src, size_t src_size, void *dst, size_t *dst_size)
{
  _CHECKSIZE(*dst_size);
#ifdef WIN32
...
HRESULT
encoding::utf16le_2_mbcs(const void *src, size_t src_size, void *dst, size_t *dst_size)
{
  _CHECKSIZE(src_size);
#ifdef WIN32
...
HRESULT
encoding::mbcs_2_utf32le(const void *src, size_t src_size, void *dst, size_t *dst_size)
{
#ifdef WIN32
  _UNUSED_PARAM;
  return E_NOTIMPL;
...
HRESULT
encoding::utf32le_2_mbcs(const void *src, size_t src_size, void *dst, size_t *dst_size)
{
#ifdef WIN32
  _UNUSED_PARAM;
  return E_NOTIMPL;
...
HRESULT
encoding::mbcs_2_utf8(const void *src, size_t src_size, void *dst, size_t *dst_size)
{
#ifdef WIN32
  _UNUSED_PARAM;
  return E_NOTIMPL;
...
HRESULT
encoding::utf8_2_mbcs(const void *src, size_t src_size, void *dst, size_t *dst_size)
{
#ifdef WIN32
  _UNUSED_PARAM;
  return E_NOTIMPL;
...
HRESULT
encoding::utf8_2_utf16le(const void *src, size_t src_size, void *dst, size_t *dst_size)
{
  _CHECKSIZE(*dst_size);
#ifdef WIN32
  size_t z = *dst_size;
...
HRESULT
encoding::utf16le_2_utf8(const void *src, size_t src_size, void *dst, size_t *dst_size)
{
  _CHECKSIZE(src_size);
#ifdef WIN32
...
HRESULT
encoding::utf8_2_utf32le(const void *src, size_t src_size, void *dst, size_t *dst_size)
{
#ifdef WIN32
  _UNUSED_PARAM;
  return E_NOTIMPL;
...
HRESULT
encoding::utf32le_2_utf8(const void *src, size_t src_size, void *dst, size_t *dst_size)
{
#ifdef WIN32
  _UNUSED_PARAM;
  return E_NOTIMPL;
...
HRESULT
encoding::utf16le_2_utf32le(const void *src, size_t src_size, void *dst, size_t *dst_size)
{
#ifdef WIN32
  _UNUSED_PARAM;
  return E_NOTIMPL;
...
HRESULT
encoding::utf32le_2_utf16le(const void *src, size_t src_size, void *dst, size_t *dst_size)
{
#ifdef WIN32
  _UNUSED_PARAM;
  return E_NOTIMPL;
