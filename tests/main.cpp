...
static int test_u16string_bytes()
{
#ifdef WIN32
...
static int test_encoding_convert()
{
    ...
    u16string_bytes_t utf16le((const u16string_bytes_t::char16_type *)&buf_utf16le[0], buf_utf16le.size() / sizeof(u16string_bytes_t::char16_type));
